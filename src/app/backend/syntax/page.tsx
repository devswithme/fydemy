  ...
  return (
    <main className="max-w-3xl mx-auto prose">
      ...
      <p>
        ...
        <code>package.json</code>. Flag <code>-y</code> bertujuan untuk set
      ...
      <p>
        Untuk package tertentu sepeti <code>prisma</code>, kita hanya butuh pada
        saat <b>fase development</b> aja jadi kita gunakan flag{" "}
        <code>--save-dev</code> untuk menginstallnya sebagai dev depedencies.
      </p>
      <pre>
      ...
      <p>
        Nah, bisa dilihat pada berkas <code>package.json</code>, properti name
        secara default adalah nama folder kita dan package <b>express</b> berada
        pada properti <code>dependencies</code> dan prisma pada properti{" "}
...
const age = require('namafile')`}</code>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            Pada properti scripts, tambahkan perintah <code>start</code>{" "}
...
`}</code>
      ...
      <p>
        Di file yang dibutuhkan misalnya <code>index.js</code>, dengan library{" "}
        <code>dotenv</code>, kita bisa require dan inisiliasi dengan perintah{" "}
        <code>dotenv.config()</code> baru kita panggil dengan awalan{" "}
        <code>process.env</code> lalu nama variabelnya.
      </p>
