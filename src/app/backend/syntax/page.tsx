	...
	return (
		<main className='max-w-3xl mx-auto prose'>
			...
			<p>
				...
				<code className='language-js'>prisma</code>, kita hanya butuh
				pada saat <b>fase development</b> aja jadi kita gunakan flag{' '}
				<code className='language-js'>--save-dev</code> untuk
				menginstallnya sebagai dev depedencies.
			</p>
			<pre>
			...
			<p>
				...
				<code className='language-js'>-g</code>. Jadi bisa dijalankan
			...
			<p>
				...
				<code className='language-js'>package.json</code>, properti
				name secara default adalah nama folder kita dan package{' '}
				<b>express</b> berada pada properti{' '}
				<code className='language-js'>dependencies</code> dan prisma
				pada properti{' '}
			...
			<ul>
				...
				<li>
					...
					<p>
						...
						<code className='language-js'>start</code> misalnya bebas,
						lalu perintahnya seperti yang di atas.
					</p>
					<pre>
						<code className='language-js'>{`package.json
{
...
`}</code>
			...
			<p>
				...
				<code className='language-js'>dotenv</code>, kita bisa require
				dan inisiliasi dengan perintah{' '}
				<code className='language-js'>dotenv.config()</code> baru kita
				panggil dengan awalan{' '}
				<code className='language-js'>process.env</code> lalu nama
				variabelnya.
			</p>
