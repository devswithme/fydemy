  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-5">
      ...
      <div className="col-span-3 relative hidden bg-neutral-900 lg:block py-48 pr-40 pl-28 text-white space-y-4 font-light">
        <h1 className="text-5xl tracking-tight text-balance">Sign up for your account today.</h1>
        <p className="max-w-lg">Start your quest now to collect XP, achieve higher rankings, and compete against other users!</p>
      </div>
