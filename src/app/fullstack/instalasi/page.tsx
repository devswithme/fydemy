	...
	return (
		<main className='max-w-3xl mx-auto prose'>
			...
			<p>
				...
				nya menggunakan{' '}
				<code className='language-js'>npm install</code> sesuai yang
				diarahkan oleh react. Setelah npm terinstall maka ada dua
				pilihan yang dimana bisa langsung run project kita atau masuk
				ke IDE kita atau Visual Studio Code kita dengan mengetikan{' '}
