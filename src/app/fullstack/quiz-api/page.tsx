...
export default function ApiReference() {
	...
	return (
		<main className='max-w-3xl mx-auto prose'>
			...
			<p className='mb-0'>
				2. Apa perbedaan utama antara <code>fetch()</code> dan{' '}
				<code>axios</code>?
			</p>
			<RadioGroup
				className='-space-y-10'
			...
			<p className='mb-0'>
				3. Apa fungsi dari <code>useEffect</code> dalam pengambilan
				data API?
			</p>
			<RadioGroup
				className='-space-y-10'
			...
			<p className='mb-0'>
				4. Kapan sebaiknya kita menggunakan <code>useEffect</code>{' '}
				dengan array dependency kosong <code>[]</code>?
			</p>
			<RadioGroup
				className='-space-y-10'
				value={form.four}
	...
	.catch(error => console.error(error));`}</code>
			...
			<p className='mb-0'>
				...
				<code>[]</code> di <code>useEffect</code>?
			</p>
			<RadioGroup
				className='-space-y-10'
				value={form.ten}
