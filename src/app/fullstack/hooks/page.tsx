...
function Lampu(){
    ...
    return (
        <div>
			...
			<ul>
				<li>
					✅ <code>useState(false)</code> artinya{' '}
					<b>lampu awalnya mati</b>
				</li>
				<li>
					✅ <code>setNyala(!nyala)</code> buat{' '}
...
function BotolSusu(){
    ...
    return (
        <div>
			...
			<ul>
				<li>
					✅ <code>useState(5)</code> artinya state awalnya 5 botol
					susu
				</li>
				<li>
					✅ <code>setJumlah(jumlah - 1)</code> buat mengurangi jumlah
					botol saat tombol ditekan
				</li>
			</ul>
			<p>
				<b>
    ...
    return (
        <div>
			...
			<ul>
				<li>
					✅{' '}
					<code>{`useEffect(() => { alert("Susu habis!"); }, [jumlah]);`}</code>{' '}
...
function Halaman(){
    ...
    return (
        <div>
			...
			<ul>
				<li>
					✅ Setiap kali <code>judul</code> berubah, judul di browser
					juga berubah!
				</li>
			</ul>
