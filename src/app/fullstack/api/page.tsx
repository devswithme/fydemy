...
export defalt PostList;`}</code>
        ...
        <ul>
          <li>
            ✅ Kita pakai <code>useState</code> buat menyimpan data API.
          </li>
          <li>
            ✅ Kita pakai <code>useEffect</code> supaya data API diambil saat
            komponen pertama kali muncul.
          </li>
          <li>
            ✅ <code>axios.get()</code> digunakan untuk mengambil data dari API.
          </li>
          <li>
...
...`}</code>
      ...
      <ul>
        <li>
          ✅ <code>axios</code> mempermudah pengambilan data dari API.
        </li>
        <li>
          ✅ <code>useEffect</code> dipakai supaya API hanya dipanggil sekali
          saat halaman pertama kali muncul.
        </li>
        <li>
          ✅ <code>useState</code> menyimpan data dari API ke dalam state agar
          bisa ditampilkan di UI.
        </li>
      </ul>
      <p>Selamat mencoba! 🎉</p>
