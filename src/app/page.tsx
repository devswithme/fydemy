					...
					<div className='space-y-8'>
						<div className='space-y-4'>
							...
							<p className='text-sm sm:text-base max-w-md text-muted-foreground'>
								Learn these topics in just one month with our
								comprehensive and up-to-date modules.
							</p>
						</div>
				...
				<section className='grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center'>
					<div className='space-y-8 md:order-1'>
						<div className='space-y-4'>
							...
							<p className='text-sm sm:text-base max-w-md text-muted-foreground'>
								Rank first to maximize benefits! Reviewed monthly,
								with a certificate and more!
							</p>
						</div>
					</div>
							...
							<ul className='space-y-1 text-sm sm:text-base'>
								<li className='flex items-center gap-x-2'>
									...
									<div className='flex-1'>
										Unlock UI/UX Design module only
									</div>
								</li>
								<li className='flex items-center gap-x-2'>
									<Check className='w-4 h-4 text-green-600' />
						...
						<CarouselContent className='-ml-6'>
							<CarouselItem className='md:basis-1/2 pl-6'>
								<div className='border border-black p-6 rounded-xl space-y-4 bg-white'>
									...
									<p className='text-muted-foreground text-sm sm:text-base'>
										This program exceeded my expectations! The modules
										were clear, up-to-date, and easy to follow. I feel
							...
							<CarouselItem className='md:basis-1/2 pl-6'>
								<div className='border border-black p-6 rounded-xl space-y-4 bg-white'>
									...
									<p className='text-muted-foreground text-sm sm:text-base'>
										I loved the structured learning approach. The
										monthly reviews kept me motivated, and the
										certificate added value to my portfolio!
									</p>
								</div>
							</CarouselItem>
							<CarouselItem className='md:basis-1/2 pl-6'>
								<div className='border border-black p-6 rounded-xl space-y-4 bg-white'>
									...
									<p className='text-muted-foreground text-sm sm:text-base'>
										Highly recommended! The content is top-notch, and
										the benefits of ranking first truly made a
										difference for me.
									</p>
								</div>
							</CarouselItem>
				...
				<footer className='bg-blue-700 rounded-xl border-2 w-full h-fit p-8 sm:p-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 border-black text-white'>
					...
					<div className='space-y-3'>
						...
						<ul className='space-y-2 text-sm sm:text-base'>
							...
							<li>
								<Link href='https://instagram.com/fysite.id'>
									Instagram
								</Link>
							</li>
							<li>
								<Link href='https://tiktok.com/@fysite.id'>
									Tiktok
								</Link>
							</li>
							<li>
