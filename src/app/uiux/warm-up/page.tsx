...
export default function ApiReference() {
	return (
		<main className='max-w-3xl mx-auto prose'>
			<h1>Sebelum Mulai..</h1>
			<p>
				Coba tebak. Dalam pembuatan aplikasi apa saja yang dibutuhkan
				dan bagaimana caranya? dan Komponen serta Step by step apa
				yang diperlukan ?
			</p>
			<Image
				src='/uiux/7.png'
			...
			<ul>
				<li>
					...
					sesuai dengan hasil riset bersama user dan menemukan solusi
					dalam pengembangan produk{' '}
				</li>
				<li>
					<b>Produk Design</b>: Membuat visualisasi produk sebelum
					launching dan experience dari user. Hal ini berkaitan erat
					juga dengan seorang UI/UX karena sebelum develompment proses
					dan menjadi sebuah aplikasi tampilan serta experience user
					sangat diperlukan{' '}
				</li>
				<li>
