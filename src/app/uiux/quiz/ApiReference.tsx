...
export default function ApiReference() {
  ...
  const onSubmit = () => {
    console.log(form);
    if (form.one == 'b' && form.two == 'a' && form.three == 'b' && form.four == 'a' && form.five == 'c') {
      setForm({
        one: '',
        two: '',
        three: '',
  ...
  return (
    <main className="max-w-3xl mx-auto prose">
      <h1>Quiz</h1>
      <p className="mb-0">1. Manakah yang merupakan tanggung jawab seorang UI?</p>
      <RadioGroup className="-space-y-10" value={form.one} onValueChange={(value) => handleChange('one', value)}>
        ...
        <label className="flex items-center space-x-3">
          ...
          <p>Mengatur dan membuat desain visual/tampilan produk semenarik mungkin</p>
        </label>
        <label className="flex items-center space-x-3">
      ...
      <p className="mb-0">2. Berikut ini merupakan proses dari UI/UX, Yaitu?</p>
      <Image src="/uiux/1.png" alt="1.png" width={1600} height={900} className="w-full sm:w-1/2 object-cover object-top rounded" />
      ...
      <p className="mb-0">3. Siapa yang bertugas merancang proses interaksi dan pengalaman bagi pengguna pada sebuah produk (aplikasi & website)?</p>
      ...
      <p className="mb-0">4. Siapa yang bertugas membangun rancangan Interface aplikasi/web untuk bisa digunakan oleh user?</p>
      ...
      <p className="mb-0">5. Untuk mengatur struktur halaman web berupa text menggunakan dan gambar?</p>
