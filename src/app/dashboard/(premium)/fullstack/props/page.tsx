...
export default function ApiReference() {
  return (
    <>
      ...
      <p>
        Haiii adik-adik Fysite! 👶✨ Hari ini kita mau belajar tentang Props di
        React! Waaah, apa itu props? Yuk, kita lihat!
      </p>
      <h3>Apa itu Props</h3>
    ...
    return <Hadiah namaHadiah="Boneka Beruang" />;
      ...
      <ul>
        <li>
          ...
          <code className="language-js">{`namaHadiah="Boneka Beruang"`}</code>{" "}
          ke <b>Hadiah</b>
          (komponen anak).
        </li>
        <li>
      ...
      <p>
        Props itu kayak paket dari mama, nggak bisa diubah oleh bayi! Jadi kalau
        komponen anak menerima props, dia cuma bisa memakai props itu, bukan
        mengubahnya.
      </p>
      ...
      <ul>
        <li>
          Teks:{" "}
          <code className="language-js">{`<Hadiah namaHadiah="Mobil Mainan" />`}</code>
        </li>
        <li>
        ...
        <li>
          Boolean:{" "}
          <code className="language-js">{`<Hadiah isBaru={true} />`}</code>
        </li>
        <li>
          Objek:{" "}
        ...
        <li>
          Fungsi:{" "}
          <code className="language-js">{`<Hadiah onClick={handleKlik} />`}</code>
        </li>
      </ul>
      ...
      <ul>
        <li>
          ✅ Props itu paket kiriman dari komponen induk ke komponen anak.
        </li>
        <li>✅ Props tidak bisa diubah oleh komponen anak.</li>
        <li>✅ Props bisa berupa teks, angka, objek, fungsi, dll.</li>
      </ul>
      <p>
        Sekian materi hari ini! Semoga belajar React jadi lebih seruuu! 🎈🥳
      </p>
