...
export default function ApiReference() {
  return (
    <>
      ...
      <p>
        Haii adik-adik Fysite! 🍼 Hari ini kita akan belajar tentang State,
        useState, dan useEffect di React. Waaah, ini penting banget kalau mau
        bikin aplikasi React yang interaktif! Yuk, kita mulai! 🚀
      </p>
      <h2>1️⃣ Apa Itu State?</h2>
      <p>
        <b>State</b> itu kayak <b>mood bayi!</b> 😆 Bayi bisa
        <b>senang</b>, <b>sedih</b>, atau <b>ngantuk</b>, dan mood-nya bisa
        berubah! Nah, di React, <b>state</b> juga bisa berubah!
      </p>
      <p>
      ...
      <p>
        React punya <b>useState</b>, biar kita bisa <b>menyimpan</b> dan{" "}
        <b>mengubah state</b>!
      </p>
...
function Lampu(){
    ...
    return (
      ...
      <ul>
        <li>
          ✅ <code className="language-js">useState(false)</code> artinya{" "}
          <b>lampu awalnya mati</b>
        </li>
        <li>
          ✅ <code className="language-js">setNyala(!nyala)</code> buat{" "}
          <b>mengubah state lampu</b>
...
function BotolSusu(){
    ...
    return (
      ...
      <ul>
        <li>
          ✅ <code className="language-js">useState(5)</code> artinya state
          awalnya 5 botol susu
        </li>
        <li>
          ✅ <code className="language-js">setJumlah(jumlah - 1)</code> buat
          mengurangi jumlah botol saat tombol ditekan
        </li>
      </ul>
      <p>
        <b>
          🍼 Kalau kita tekan tombol, botol susu akan berkurang satu per satu!
        </b>
      </p>
      <h2>3️⃣ Apa Itu useEffect?</h2>
      <p>
        useEffect itu kayak alarm bayi! ⏰ Kalau ada perubahan mood bayi
        (state), mama harus bereaksi!
      </p>
      <p>
        💡 useEffect dipakai kalau kita ingin React melakukan sesuatu setelah
        state berubah!
      </p>
      <p>Misalnya:</p>
      <ul>
...
function Halaman(){
    ...
    return (
      ...
      <ul>
        <li>
          ✅ Setiap kali <code className="language-js">judul</code> berubah,
          judul di browser juga berubah!
        </li>
      </ul>
      ...
      <p>
        🎈 Sekian materi kita hari ini! Semoga belajar React jadi lebih seruuu!
        🥳
      </p>
      ...
      <div className="bg-muted w-full border-t fixed right-0 md:pl-64 bottom-0 py-4">
        <div className="flex justify-between items-center max-w-3xl mx-auto px-5 lg:px-0">
          <Link href={navItems[3].items[7].url} className="invisible">
            <ChevronLeft className="w-5 h-5" />
          </Link>
          <span className="font-semibold">{navItems[3].items[6].title}</span>
