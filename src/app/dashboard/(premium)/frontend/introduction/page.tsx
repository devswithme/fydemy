  ...
  return (
    <>
      ...
      <p>
        ...
        latihan ini misal namanya <code className="language-js">frontend</code>.
      </p>
      <Image
        src="/frontend/1.png"
        alt="1.png"
      ...
      <p>
        ...
        <code className="language-js">index.html</code>. Lalu, tekan enter untuk
        membuatnya. Perlu diperhatikan disini website pada umumnya memiliki
        struktur file:
      </p>
      <ul>
        <li>
          <b>HTML (Hypertext Markup Language)</b>{" "}
          <code className="language-js">format: *.html</code> sebagai kerangka
          dalam pembuatan elemen seperti judul, tulisan, gambar, link, tombol,
          dan sebagainya
        </li>
        <li>
          <b>CSS (Cascading Style Sheets)</b>
          <code className="language-js">format: *.css</code> sebagai style untuk
          memberikan gaya terhadap elemen dari HTML seperti font-size, warna,
          font, margin, padding dan sebagainya
        </li>
        <li>
          <b>Javascript</b> <code className="language-js">format: *.js</code>
          sebagai logika untuk membuat website lebih interaktif, dinamis,
      ...
      <p>
        ...
        <code className="language-js">{`<!-- ... -->`}</code> itu tidak akan
        dijalankan oleh program alias untuk pemberi informasi saja atau komentar
        agar mengerti maksud dari kodenya.
      </p>
      <h3>Tag</h3>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              <code className="language-js">{`<br />`}</code> untuk line break,
              dan masih banyak lagi
            </li>
          </ul>
        </li>
...
`}</code>
      ...
      <p>
        ...
        bisa generate kode ini dengan shortcut{" "}
        <code className="language-js">! + Tab/Enter</code>. Struktur ini
        mencangkup judul website, metadata, dan <b>body</b> dimana kita menulis
        kontennya.
      </p>
      <h2>CSS</h2>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            <code className="language-js">style.css</code>. Lalu, import cssnya
            ingat untuk sesuaikan atribut hrefnya dengan nama file kalian.
          </p>
          <p>
            <b>Penting:</b> Langkah selanjutnya adalah mendefinisikan nama style
            terserah kalian misalnya <code className="language-js">header</code>{" "}
            sebagai penanda di file cssnya nanti didalam atribut kelas pada
...
`}</code>
          ...
          <p>
            ...
            bebaslah berkreasi dengan properti seperti{" "}
            <code className="language-js">text-align</code> dan masih banyak
            lagi didalam kurung kurawal.{" "}
