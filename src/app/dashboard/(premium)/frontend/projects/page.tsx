...
export default async function Home() {
  return (
    <>
      ...
      <p>
        Disini kalian harus paham dengan konsep HTML mengenai elemen list,
        heading, gambar dan CSS mengenai layout, padding, border. Ini adalah
        layout prototypenya saja, semoga berhasil!
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <code className="language-js">{`<img src="..."/>`}</code> , bisa
          import dari file lokal anda (dalam folder yang sama) atau dari url
          internet
        </li>
        <li>
...
`}</code>
      ...
      <p>
        Disini kalian harus paham antara gabungan HTML mengenai button, CSS
        mengenai layouting, Javascript mengenai DOM. Ini adalah layout
        prototypenya, semoga berhasil!
      </p>
      <h3>Tips dan syarat</h3>
      <ul>
        <li>
          Tombol selengkapnya jika diklik, menuju ke halaman instagram anda
        </li>
        <li>
          Pastikan layoutnya sama persis posisinya dengan contoh. Bisa dilakukan
          dengan konsep <b>flex box</b> dalam CSS.
          <pre>
	...
	<img src="..."/>
        ...
        <li>
          Menggunakan object window untuk implementasi tombol ke halama lain{" "}
